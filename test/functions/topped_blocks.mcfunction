...
execute unless score topped_blocks funcs matches 0..3 run scoreboard players set topped_blocks funcs 0
...
execute if score topped_blocks funcs matches 2 run setblock ~ ~3 ~ minecraft:mycelium
execute if score topped_blocks funcs matches 2 run data merge block ~1 ~2 ~ {Text1:"\"\"",Text2:"\"Mycelium\""}



execute if score topped_blocks funcs matches 3 run setblock ~ ~3 ~ minecraft:podzol
execute if score topped_blocks funcs matches 3 run data merge block ~1 ~2 ~ {Text1:"\"\"",Text2:"\"Podzol\""}