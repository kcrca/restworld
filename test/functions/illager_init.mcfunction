...
summon minecraft:vex ~-6 ~3 ~0 {CustomName:"\"Vex\"",Tags:[vex],LifeTicks:2147483647,NoAI:True,Silent:True,Rotation:[180f,0f]}
summon minecraft:phantom ~-5 ~5 ~5 {CustomName:"\"Phantom\"",Tags:[],NoAI:True,Silent:True,Rotation:[180f,0f]}