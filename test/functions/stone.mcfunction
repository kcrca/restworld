...
execute if score stone funcs matches 0 run data merge block ~ ~3 ~ {mode:stone}
execute if score stone funcs matches 0 run data merge block ~-1 ~2 ~ {Text2:"\"Stone\""}



execute if score stone funcs matches 1 run data merge block ~ ~3 ~ {mode:smooth_stone}
