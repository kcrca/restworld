...
summon minecraft:ghast ~0 ~6 ~1 {CustomName:"\"Ghast\"",Tags:[adult],NoAI:True,Silent:True,Rotation:[90f,0f]}
summon minecraft:blaze ~-4 ~2 ~1.5 {CustomName:"\"Blaze\"",Tags:[adult],NoAI:True,Silent:True,Rotation:[0f,0f]}
