...
from pynecraft._values import ORANGE_POPLAR_LEAVES, RED_POPLAR_LEAVES, SULFUR_CAVES, YELLOW_POPLAR_LEAVES
...
from pynecraft.info import ABSORPTION, ANGRY_VILLAGER, as_particle, ASH, BASALT_DELTAS, BLINDNESS, BLOCK_CRUMBLE, \
...
actions = [
    ...
    action(FISHING),
    action(GUST, 'Gust|Gust Emitter', also=(GUST_EMITTER_LARGE, GUST_EMITTER_SMALL)),  # Also in arena, can be removed
...
elsewhere = {
    ...
    'Plants': (SPORE_BLOSSOM_AIR, FALLING_SPORE_BLOSSOM, CHERRY_LEAVES, PALE_OAK_LEAVES, TINTED_LEAVES,
               RED_POPLAR_LEAVES, ORANGE_POPLAR_LEAVES, YELLOW_POPLAR_LEAVES, UNDERWATER),
