...
from restworld import ancient, global_, aquatic, arena, banners, biomes, tags, blocks, center, containers, diy, effects, \
    particles, enders, font, friendlies, materials, monsters, nether, paintings, photo, plants
...
def main():
    for f in (
            ...
            materials.room, monsters.room, nether.room, paintings.room, photo.room, plants.room):
        f()
    tags.tags()
    restworld.save()
