...
from pyker.commands import mc, r, EAST, FORCE, e, Block, d, Entity
...
def room():
    ...
    room.function('reset').add(
        ...
        mc.execute().at(e().tag('diy_starter')).run().fill(r(0, 5, 0), r(0, 5, -6), 'sand'),
        mc.execute().at(e().tag('diy_ender')).run().tp(e().tag('diy_cloner'), r(0, 2, 0)),
    ...
    room.function('restore').add(
        ...
        mc.execute().at(e().tag('diy_starter')).run().setblock(r(0, -2, 0), 'redstone_torch'),
        mc.execute().at(e().tag('diy_starter')).run().setblock(r(0, -2, 0), 'air'))
    room.function('save').add(
        mc.execute().at(e().tag('diy_ender')).run().setblock(r(0, -1, 0), Block(
            r'structure_block',
        ...
        mc.execute().at(e().tag('diy_ender')).run().setblock(r(0, -2, 0), 'redstone_torch'),
        mc.execute().at(e().tag('diy_ender')).run().setblock(r(0, -2, 0), 'air'),
        mc.execute().at(e().tag('diy_ender')).run().setblock(r(0, -1, 0), 'stone'),
        mc.setblock(r(0, -4, 0), 'redstone_torch'),
        mc.setblock(r(0, -4, 0), 'air'))
    ...
    room.loop('tick', main_clock).add(
        mc.execute().at(e().tag('diy_cloner')).run().setblock(r(0, 3, 0), 'sand'),
        custom_reset.set(0),
        mc.execute().at(e().tag('diy_cloner')).unless().block(r(0, 0, -1), 'air').run(custom_reset.set(1)),
        mc.execute().at(e().tag('diy_cloner')).if_().block(r(0, 4, -1), 'air').run(custom_reset.set(1)),
        mc.execute().if_().score(custom_reset).matches(1).at(e().tag('diy_starter')
                                                             ).run().tp(e().tag('diy_cloner'), r(0, 2, 0)),
        mc.execute().if_().score(custom_reset).matches(0).as_(e().tag('diy_cloner')).at(
            e().tag('diy_cloner')).run().tp(e().tag('diy_cloner'), d(0, 0, 1)),
        mc.execute().at(e().tag('diy_cloner')).unless().block(r(0, 4, 0), 'air').run(
        ).setblock(r(0, 3, 0), 'magenta_glazed_terracotta'),
        mc.execute().at(e().tag('diy_cloner')).run(
        ...
        mc.execute().at(e().tag('diy_cloner')).run().setblock(r(0, -2, 0), 'redstone_torch'),
        mc.execute().at(e().tag('diy_cloner')).run().setblock(r(0, -2, 0), 'air'),
        mc.execute().at(e().tag('diy_cloner')).run().setblock(r(0, -1, 0), 'stone'),
        mc.execute().at(e().tag('diy_displayer')).run().setblock(r(0, -2, 0), 'redstone_torch'),
        mc.execute().at(e().tag('diy_displayer')).run().setblock(r(0, -2, 0), 'air')
    )
