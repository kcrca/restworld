...
execute at @e[tag=diy_cloner] unless block ~0 ~4 ~0 air run setblock ~0 ~3 ~0 minecraft:magenta_glazed_terracotta
execute at @e[tag=diy_cloner] run setblock ~0 ~-1 ~0 structure_block{ignoreEntities:true,name:"minecraft:singleton",mode:"SAVE",posX:0,posY:5,posZ:0,sizeX:1,sizeY:1,sizeZ:1,showboundingbox:false}
