...
execute if score zombie_jockey funcs matches 0 run execute if score zombie funcs matches 0 run summon minecraft:zombie ~-1.7 ~2 ~0 {Tags:[zombie,kid,zombieish,monsters,monsters],IsBaby:True,Age:-2147483648,CustomName:"\"Zombie\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[90f,0f]}
...
execute if score zombie_jockey funcs matches 1 run execute if score zombie funcs matches 0 run summon minecraft:chicken ~-1.7 ~2 ~0 {Tags:[chicken,kid,zombieish,monsters,monsters],Passengers:[{id:"minecraft:zombie",Tags:[zombie,kid,monsters],IsBaby:True,Age:-2147483648,Rotation:[90f,0f],PersistenceRequired:True,NoAI:True,Silent:True}],IsBaby:True,Age:-2147483648,CustomName:"\"Chicken\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[90f,0f]}



execute if score zombie_jockey funcs matches 0 run execute if score zombie funcs matches 1 run summon minecraft:husk ~-1.7 ~2 ~0 {Tags:[husk,kid,zombieish,monsters,monsters],IsBaby:True,Age:-2147483648,CustomName:"\"Husk\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[90f,0f]}
...
execute if score zombie_jockey funcs matches 0 run execute if score zombie funcs matches 2 run summon minecraft:drowned ~-1.7 ~2 ~0 {Tags:[drowned,kid,zombieish,monsters,monsters],IsBaby:True,Age:-2147483648,CustomName:"\"Drowned\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[90f,0f]}
