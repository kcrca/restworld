...
execute if score zombie funcs matches 0 run summon minecraft:zombie ~-1.7 ~2 ~0 {Tags:[zombie,kid,zombieish,monsters,monsters],IsBaby:True,Age:-2147483648,PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[90f,0f]}
...
execute if score zombie funcs matches 1 run summon minecraft:husk ~-1.7 ~2 ~0 {Tags:[husk,kid,zombieish,monsters,monsters],IsBaby:True,Age:-2147483648,PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[90f,0f]}
...
execute if score zombie funcs matches 2 run summon minecraft:drowned ~-1.7 ~2 ~0 {Tags:[drowned,kid,zombieish,monsters,monsters],IsBaby:True,Age:-2147483648,PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[90f,0f]}
