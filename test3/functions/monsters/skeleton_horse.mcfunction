...
execute if score skeleton_horse funcs matches 1 run summon minecraft:skeleton_horse ~-0.8 ~2 ~0 {Tags:[skeleton_horse,monsters,monsters],Passengers:[{id:"minecraft:skeleton",ArmorItems:[{},{},{},{id:"minecraft:iron_helmet",Count:1,tag:{RepairCost:1,Enchantments:[{lvl:3,id:"minecraft:unbreaking"}]}}],HandItems:[{id:"minecraft:bow",Count:1b,tag:{RepairCost:1,Enchantments:[{lvl:3s,id:"minecraft:unbreaking"}]}},{}],Tags:[monsters],Rotation:[270f,0f],Facing:east,PersistenceRequired:True,NoAI:True,Silent:True}],CustomName:"\"Skeleton Horse\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
