...
execute if score skeleton_horse funcs matches 0 run summon minecraft:skeleton_horse ~-0.2 ~2 ~0 {Tags:[skeleton_horse,monsters],CustomName:"\"Skeleton Horse\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}

execute if score skeleton_horse funcs matches 1 run summon minecraft:skeleton_horse ~-0.2 ~2 ~0 {Tags:[skeleton_horse,monsters],Passengers:[{id:"minecraft:skeleton",Tags:[monsters],Rotation:[270f,0f],Facing:east,PersistenceRequired:True,NoAI:True,Silent:True}],CustomName:"\"Skeleton Horse\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
