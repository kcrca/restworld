execute unless score sapling funcs matches 0.. run function sapling_init
scoreboard players add sapling funcs 1
execute unless score sapling funcs matches 0..1 run scoreboard players set sapling funcs 0
