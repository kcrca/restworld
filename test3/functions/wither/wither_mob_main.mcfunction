...
execute if score wither_mob funcs matches 0 run data merge entity @e[tag=wither_mob,limit=1] {Health:300,Invul:100}
execute if score wither_mob funcs matches 0 run data merge block ~0 ~2 ~-2 {Text2:"\"Inulverable (New)\""}
execute if score wither_mob funcs matches 1 run data merge entity @e[tag=wither_mob,limit=1] {Health:300,Invul:0}
execute if score wither_mob funcs matches 1 run data merge block ~0 ~2 ~-2 {Text2:"\"Healthy\""}
execute if score wither_mob funcs matches 2 run data merge entity @e[tag=wither_mob,limit=1] {Health:140,Invul:0}
