...
execute if score cow funcs matches 0 run summon minecraft:cow ~1.4 ~2 ~0 {Tags:[cow,kid,friendlies,cowish,friendlies],IsBaby:True,Age:-2147483648,PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
...
execute if score cow funcs matches 1 run summon minecraft:mooshroom ~1.4 ~2 ~0 {Tags:[mooshroom,kid,friendlies,cowish,friendlies],IsBaby:True,Age:-2147483648,PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
