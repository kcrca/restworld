...
execute as @e[tag=friendlies_home] run data merge entity @s {Invisible:false}
...
execute as @e[tag=monsters_home] run data merge entity @s {Invisible:false}
...
execute as @e[tag=acquatic_home] run data merge entity @s {Invisible:false}
...
execute as @e[tag=wither_home] run data merge entity @s {Invisible:false}
