...
execute if score mob_levitation funcs matches 0 run say 0!
execute if score mob_levitation funcs matches 1 run say 1!

execute if score mob_levitation funcs matches 1 run execute at @e[tag=sleeping_bat] run say clone ~ ~1 ~ ~ ~1 ~ ~ ~3 ~ replace move
...
execute if score mob_levitation funcs matches 0 run execute at @e[tag=sleeping_bat] run say clone ~ ~1 ~ ~ ~1 ~ ~ ~-1 ~ replace move
