...
execute if score arena_is_night funcs matches 0 at @e[tag=controls_home] run data merge block ~-2 ~1 ~1 {Text4:"\"Off\""}
execute if score arena_is_night funcs matches 1 run time set noon
execute if score arena_is_night funcs matches 1 at @e[tag=controls_home] run data merge block ~-2 ~1 ~1 {Text4:"\"On\""}
