...
execute if score arena_is_grass funcs matches 0 at @e[tag=controls_home] run data merge block ~-2 ~1 ~-1 {Text4:"\"Off\""}
execute if score arena_is_grass funcs matches 1 run clone ~20 ~-11 ~20 ~-20 ~-11 ~-20 ~-20 ~-1 ~-20
execute if score arena_is_grass funcs matches 1 at @e[tag=controls_home] run data merge block ~-2 ~1 ~0 {Text4:"\"On\""}
