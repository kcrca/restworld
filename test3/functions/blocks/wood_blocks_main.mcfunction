...
execute if score wood_blocks funcs matches 0 run data merge block ~-3 ~2 ~-2 {Text2:"\"Stripped\"",Text3:"\"Acacia Wood\"",Text4:"\"\""}
...
execute if score wood_blocks funcs matches 1 run data merge block ~-3 ~2 ~-2 {Text2:"\"Stripped\"",Text3:"\"Birch Wood\"",Text4:"\"\""}
...
execute if score wood_blocks funcs matches 2 run data merge block ~-3 ~2 ~-2 {Text2:"\"Stripped\"",Text3:"\"Jungle Wood\"",Text4:"\"\""}
...
execute if score wood_blocks funcs matches 3 run data merge block ~-3 ~2 ~-2 {Text2:"\"Stripped\"",Text3:"\"Oak Wood\"",Text4:"\"\""}
...
execute if score wood_blocks funcs matches 4 run data merge block ~-3 ~2 ~-2 {Text2:"\"Stripped\"",Text3:"\"Dark Oak Wood\"",Text4:"\"\""}
...
execute if score wood_blocks funcs matches 5 run data merge block ~-3 ~2 ~-2 {Text2:"\"Stripped\"",Text3:"\"Spruce Wood\"",Text4:"\"\""}
