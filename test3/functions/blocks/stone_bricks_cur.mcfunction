...
execute if score stone_bricks funcs matches 1 run data merge block ~0 ~2 ~-1 {Text2:"\"Mossy Stone Bricks\"",Text3:"\"\"",Text4:"\"\""}


execute if score stone_bricks funcs matches 2 run setblock ~0 ~3 ~0 minecraft:cracked_stone_bricks
execute if score stone_bricks funcs matches 2 run data merge block ~0 ~2 ~-1 {Text2:"\"Cracked Stone Bricks\"",Text3:"\"\"",Text4:"\"\""}


execute if score stone_bricks funcs matches 3 run setblock ~0 ~3 ~0 minecraft:chiseled_stone_bricks
execute if score stone_bricks funcs matches 3 run data merge block ~0 ~2 ~-1 {Text2:"\"Chiseled Stone Bricks\"",Text3:"\"\"",Text4:"\"\""}
