...
execute if score hopper funcs matches 0 run setblock ~2 ~3 ~2 oak_wall_sign[facing=west]
execute if score hopper funcs matches 0 run data merge block ~2 ~3 ~2 {Text2:"\"Which way are\"",Text3:"\"they pointing?\""}
