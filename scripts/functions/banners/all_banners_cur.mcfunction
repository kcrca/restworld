...
execute if score all_banners funcs matches 0 run setblock ~10.8 ~3 ~10.8 white_banner[rotation=6]{Patterns:[{Color:15,Pattern:"sc"},{Color:0,Pattern:"sc"},{Color:15,Pattern:"flo"},{Color:0,Pattern:"flo"}]}
execute if score all_banners funcs matches 0 run execute as @e[tag=all_banners_home] run execute at @s positioned ~10.8 ~3 ~10.8 as @e[tag=banner_pattern_custom,distance=..2] run data merge entity @s {CustomName:"\"Quartz sculpte\""}
execute if score all_banners funcs matches 0 run execute as @e[tag=all_banners_home] run execute at @s positioned ~10.8 ~3 ~10.8 as @e[tag=banner_pattern_custom_author,distance=..2] run data merge entity @s {CustomName:"\"by Pikachu\""}
...
execute if score all_banners funcs matches 1 run setblock ~10.8 ~3 ~10.8 black_banner[rotation=6]{Patterns:[{Color:5,Pattern:"cbo"},{Color:15,Pattern:"rs"},{Color:14,Pattern:"flo"},{Color:5,Pattern:"ms"},{Color:15,Pattern:"tt"},{Color:5,Pattern:"moj"}]}
execute if score all_banners funcs matches 1 run execute as @e[tag=all_banners_home] run execute at @s positioned ~10.8 ~3 ~10.8 as @e[tag=banner_pattern_custom,distance=..2] run data merge entity @s {CustomName:"\"DRAGON !\""}
execute if score all_banners funcs matches 1 run execute as @e[tag=all_banners_home] run execute at @s positioned ~10.8 ~3 ~10.8 as @e[tag=banner_pattern_custom_author,distance=..2] run data merge entity @s {CustomName:"\"by kraftime\""}
...
execute if score all_banners funcs matches 2 run setblock ~10.8 ~3 ~10.8 white_banner[rotation=6]{Patterns:[{Color:15,Pattern:"ts"},{Color:0,Pattern:"sc"},{Color:14,Pattern:"hhb"},{Color:0,Pattern:"bo"},{Color:0,Pattern:"bs"},{Color:4,Pattern:"ms"}]}
execute if score all_banners funcs matches 2 run execute as @e[tag=all_banners_home] run execute at @s positioned ~10.8 ~3 ~10.8 as @e[tag=banner_pattern_custom,distance=..2] run data merge entity @s {CustomName:"\"Poule\""}
execute if score all_banners funcs matches 2 run execute as @e[tag=all_banners_home] run execute at @s positioned ~10.8 ~3 ~10.8 as @e[tag=banner_pattern_custom_author,distance=..2] run data merge entity @s {CustomName:"\"by mish80\""}
...
execute if score all_banners funcs matches 3 run setblock ~10.8 ~3 ~10.8 black_banner[rotation=6]{Patterns:[{Color:14,Pattern:"gru"},{Color:14,Pattern:"bt"},{Color:0,Pattern:"bts"},{Color:0,Pattern:"tts"}]}
execute if score all_banners funcs matches 3 run execute as @e[tag=all_banners_home] run execute at @s positioned ~10.8 ~3 ~10.8 as @e[tag=banner_pattern_custom,distance=..2] run data merge entity @s {CustomName:"\"Bouche\""}
execute if score all_banners funcs matches 3 run execute as @e[tag=all_banners_home] run execute at @s positioned ~10.8 ~3 ~10.8 as @e[tag=banner_pattern_custom_author,distance=..2] run data merge entity @s {CustomName:"\"by entonix69\""}
...
execute if score all_banners funcs matches 4 run setblock ~10.8 ~3 ~10.8 lime_banner[rotation=6]{Patterns:[{Color:4,Pattern:"gra"},{Color:3,Pattern:"gru"},{Color:0,Pattern:"cbo"},{Color:0,Pattern:"cr"},{Color:0,Pattern:"mr"},{Color:5,Pattern:"mc"}]}
execute if score all_banners funcs matches 4 run execute as @e[tag=all_banners_home] run execute at @s positioned ~10.8 ~3 ~10.8 as @e[tag=banner_pattern_custom,distance=..2] run data merge entity @s {CustomName:"\"Like pls ^-^\""}
execute if score all_banners funcs matches 4 run execute as @e[tag=all_banners_home] run execute at @s positioned ~10.8 ~3 ~10.8 as @e[tag=banner_pattern_custom_author,distance=..2] run data merge entity @s {CustomName:"\"by Harmony\""}
