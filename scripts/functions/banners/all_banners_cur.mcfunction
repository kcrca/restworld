...
execute if score all_banners funcs matches 1 run execute as @e[tag=banner_pattern_custom] run data merge entity @s {CustomName:"\"Portail du Nether\""}
execute if score all_banners funcs matches 1 run execute as @e[tag=banner_pattern_custom_author] run data merge entity @s {CustomName:"\"by Akkta\""}
...
execute if score all_banners funcs matches 2 run execute as @e[tag=banner_pattern_custom] run data merge entity @s {CustomName:"\"Fox\""}
execute if score all_banners funcs matches 2 run execute as @e[tag=banner_pattern_custom_author] run data merge entity @s {CustomName:"\"by mr.crafteur\""}
...
execute if score all_banners funcs matches 3 run execute as @e[tag=banner_pattern_custom] run data merge entity @s {CustomName:"\"Rabbit\""}
execute if score all_banners funcs matches 3 run execute as @e[tag=banner_pattern_custom_author] run data merge entity @s {CustomName:"\"by googolplexbyte\""}
...
execute if score all_banners funcs matches 4 run execute as @e[tag=banner_pattern_custom] run data merge entity @s {CustomName:"\"Angel\""}
execute if score all_banners funcs matches 4 run execute as @e[tag=banner_pattern_custom_author] run data merge entity @s {CustomName:"\"by PK?\""}

execute if score all_banners funcs matches 5 run setblock ~0.2 ~3 ~0.2 white_banner[rotation=14]{Patterns:[{Color:15,Pattern:"sc"},{Color:0,Pattern:"sc"},{Color:15,Pattern:"flo"},{Color:0,Pattern:"flo"}]}
execute if score all_banners funcs matches 5 run execute as @e[tag=banner_pattern_custom] run data merge entity @s {CustomName:"\"Quartz sculpte\""}
execute if score all_banners funcs matches 5 run execute as @e[tag=banner_pattern_custom_author] run data merge entity @s {CustomName:"\"by Pikachu\""}

execute if score all_banners funcs matches 6 run setblock ~0.2 ~3 ~0.2 black_banner[rotation=14]{Patterns:[{Color:5,Pattern:"cbo"},{Color:15,Pattern:"rs"},{Color:14,Pattern:"flo"},{Color:5,Pattern:"ms"},{Color:15,Pattern:"tt"},{Color:5,Pattern:"moj"}]}
execute if score all_banners funcs matches 6 run execute as @e[tag=banner_pattern_custom] run data merge entity @s {CustomName:"\"DRAGON !\""}
execute if score all_banners funcs matches 6 run execute as @e[tag=banner_pattern_custom_author] run data merge entity @s {CustomName:"\"by kraftime\""}

execute if score all_banners funcs matches 7 run setblock ~0.2 ~3 ~0.2 white_banner[rotation=14]{Patterns:[{Color:15,Pattern:"ts"},{Color:0,Pattern:"sc"},{Color:14,Pattern:"hhb"},{Color:0,Pattern:"bo"},{Color:0,Pattern:"bs"},{Color:4,Pattern:"ms"}]}
execute if score all_banners funcs matches 7 run execute as @e[tag=banner_pattern_custom] run data merge entity @s {CustomName:"\"Poule\""}
execute if score all_banners funcs matches 7 run execute as @e[tag=banner_pattern_custom_author] run data merge entity @s {CustomName:"\"by mish80\""}

execute if score all_banners funcs matches 8 run setblock ~0.2 ~3 ~0.2 black_banner[rotation=14]{Patterns:[{Color:14,Pattern:"gru"},{Color:14,Pattern:"bt"},{Color:0,Pattern:"bts"},{Color:0,Pattern:"tts"}]}
