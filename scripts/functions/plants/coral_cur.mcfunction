...
execute if score coral funcs matches 0 run setblock ~0 ~2 ~2 minecraft:oak_wall_sign[facing=west,waterlogged=false]{Text2:"\"Brain Coral\""}
...
execute if score coral funcs matches 0 run setblock ~-1 ~2 ~4 minecraft:dead_brain_coral_wall_fan[facing=west]
...
execute if score coral funcs matches 1 run setblock ~0 ~2 ~2 minecraft:oak_wall_sign[facing=west,waterlogged=false]{Text2:"\"Bubble Coral\""}
...
execute if score coral funcs matches 1 run setblock ~-1 ~2 ~4 minecraft:dead_bubble_coral_wall_fan[facing=west]
...
execute if score coral funcs matches 2 run setblock ~0 ~2 ~2 minecraft:oak_wall_sign[facing=west,waterlogged=false]{Text2:"\"Fire Coral\""}
...
execute if score coral funcs matches 2 run setblock ~-1 ~2 ~4 minecraft:dead_fire_coral_wall_fan[facing=west]
...
execute if score coral funcs matches 3 run setblock ~0 ~2 ~2 minecraft:oak_wall_sign[facing=west,waterlogged=false]{Text2:"\"Horn Coral\""}
...
execute if score coral funcs matches 3 run setblock ~-1 ~2 ~4 minecraft:dead_horn_coral_wall_fan[facing=west]
...
execute if score coral funcs matches 4 run setblock ~0 ~2 ~2 minecraft:oak_wall_sign[facing=west,waterlogged=false]{Text2:"\"Tube Coral\""}
...
execute if score coral funcs matches 4 run setblock ~-1 ~2 ~4 minecraft:dead_tube_coral_wall_fan[facing=west]
