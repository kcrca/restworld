execute positioned ~ ~-5 ~ run tp @e[type=!player,tag=!homer,dx=64,dy=45,dz=64] @e[tag=reaper_home,limit=1]
...
execute positioned ~ ~-5 ~ run tp @e[type=item,dx=64,dy=45,dz=64] @e[tag=reaper_home,limit=1]
