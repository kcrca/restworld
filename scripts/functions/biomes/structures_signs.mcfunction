...
setblock ~3 ~0 ~9 birch_wall_sign{Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute run execute at @e[tag=biome_loading_home] run function v3:biomes/clear_biome\"}}",Text2:"{\"text\":\"Mineshaft\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute run scoreboard players set load_biome funcs 22\"}}",Text3:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute run execute at @e[tag=biome_loading_home] run function v3:biomes/load_biome_cur\"}}",}
setblock ~2 ~0 ~9 birch_wall_sign{Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute run execute at @e[tag=biome_loading_home] run function v3:biomes/clear_biome\"}}",Text2:"{\"text\":\"Monument\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute run scoreboard players set load_biome funcs 23\"}}",Text3:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute run execute at @e[tag=biome_loading_home] run function v3:biomes/load_biome_cur\"}}",}

setblock ~3 ~1 ~9 birch_wall_sign{Text2:"{\"text\":\"Structures\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=category_home] positioned ~ ~2 ~ run function v3:biomes/category\"}}",Text3:"\"Biomes\""}
