...
execute if score stone funcs matches 0 run data merge block ~0 ~2 ~-1 {Text2:"\"Stone\"",Text3:"\"\"",Text4:"\"\""}

execute if score stone funcs matches 0 run setblock ~0 ~3 ~3 minecraft:smooth_stone
execute if score stone funcs matches 0 run data merge block ~0 ~2 ~2 {Text2:"\"Smooth Stone\"",Text3:"\"\"",Text4:"\"\""}


execute if score stone funcs matches 1 run setblock ~0 ~3 ~0 minecraft:andesite
execute if score stone funcs matches 1 run data merge block ~0 ~2 ~-1 {Text2:"\"Andesite\"",Text3:"\"\"",Text4:"\"\""}

execute if score stone funcs matches 1 run setblock ~0 ~3 ~3 minecraft:polished_andesite
execute if score stone funcs matches 1 run data merge block ~0 ~2 ~2 {Text2:"\"Polished Andesite\"",Text3:"\"\"",Text4:"\"\""}


execute if score stone funcs matches 2 run setblock ~0 ~3 ~0 minecraft:diorite
execute if score stone funcs matches 2 run data merge block ~0 ~2 ~-1 {Text2:"\"Diorite\"",Text3:"\"\"",Text4:"\"\""}

execute if score stone funcs matches 2 run setblock ~0 ~3 ~3 minecraft:polished_diorite
execute if score stone funcs matches 2 run data merge block ~0 ~2 ~2 {Text2:"\"Polished Diorite\"",Text3:"\"\"",Text4:"\"\""}


execute if score stone funcs matches 3 run setblock ~0 ~3 ~0 minecraft:granite
execute if score stone funcs matches 3 run data merge block ~0 ~2 ~-1 {Text2:"\"Granite\"",Text3:"\"\"",Text4:"\"\""}

execute if score stone funcs matches 3 run setblock ~0 ~3 ~3 minecraft:polished_granite
execute if score stone funcs matches 3 run data merge block ~0 ~2 ~2 {Text2:"\"Polished Granite\"",Text3:"\"\"",Text4:"\"\""}
