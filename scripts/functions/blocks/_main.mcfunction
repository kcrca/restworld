...
execute at @e[tag=chest_home] run function v3:blocks/chest_main
...
execute at @e[tag=item_frame_home] run function v3:blocks/item_frame_main
...
execute at @e[tag=lighting_home] run function v3:blocks/lighting_main
