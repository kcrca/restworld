...
execute if score composter funcs matches 0 run say Composter[level=0]
...
execute if score composter funcs matches 1 run say Composter[level=1]
...
execute if score composter funcs matches 2 run say Composter[level=2]
...
execute if score composter funcs matches 3 run say Composter[level=3]
...
execute if score composter funcs matches 4 run say Composter[level=4]
...
execute if score composter funcs matches 5 run say Composter[level=5]
...
execute if score composter funcs matches 6 run say Composter[level=6]
...
execute if score composter funcs matches 7 run say Composter[level=7]
...
execute if score composter funcs matches 8 run say Composter[level=8]
