...
execute if score job_sites_1 funcs matches 0 run say Fletching Table
...
execute if score job_sites_1 funcs matches 1 run say Cartography Table
...
execute if score job_sites_1 funcs matches 2 run say Smithing Table
...
execute if score job_sites_1 funcs matches 3 run say Loom
...
execute if score job_sites_1 funcs matches 4 run say Stonecutter
