...
execute if score cauldron funcs matches 0 run say Cauldron[level=0]
...
execute if score cauldron funcs matches 1 run say Cauldron[level=1]
...
execute if score cauldron funcs matches 2 run say Cauldron[level=2]
...
execute if score cauldron funcs matches 3 run say Cauldron[level=3]
