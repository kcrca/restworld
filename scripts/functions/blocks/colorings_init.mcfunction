...
setblock ~-5 ~4 ~2 oak_wall_sign[facing=south]{Text2:"\"Shulker Box\""}
setblock ~-3 ~4 ~2 oak_wall_sign[facing=south]{Text2:"\"Terracotta\""}
setblock ~-5 ~4 ~0 oak_wall_sign[facing=south]{Text2:"\"Banner\""}
