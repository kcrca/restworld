...
execute if score cow funcs matches 2 run summon minecraft:mooshroom ~1.4 ~2 ~0 {Tags:[mooshroom,kid,friendlies,cowish,friendlies],Type:brown,IsBaby:True,Age:-2147483648,CustomName:"\"MooShroom\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
execute if score cow funcs matches 2 run summon minecraft:mooshroom ~-1.2 ~2 ~0 {Tags:[mooshroom,friendlies,cowish,friendlies],Type:brown,CustomName:"\"MooShroom\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
