setblock ~0 ~-2 ~0 structure_block{ignoreEntities:true,name:"restworld:sequence",mode:"SAVE",posX:0,posY:4,posZ:-6,sizeX:1,sizeY:1,sizeZ:7,showboundingbox:false}
