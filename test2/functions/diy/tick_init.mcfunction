...
summon minecraft:armor_stand ~-1 ~-3.5 ~-6 {Tags:[ender,customizer],NoGravity:True,Small:True,ArmorItems:[{},{},{},{id:turtle_helmet,Count:1}],Rotation:[180f,0f]}


summon minecraft:armor_stand ~-1 ~-1.5 ~0 {Tags:[cloner,customizer],NoGravity:True,Small:True,ArmorItems:[{},{},{},{id:turtle_helmet,Count:1}],Rotation:[180f,0f]}
