...
execute if score materials funcs matches 2 run execute unless entity @e[tag=armor_horse,distance=..10] run summon minecraft:horse ~4.5 ~1.5 ~0.5 {Variant:1,Tame:True,NoAI:True,Silent:True,Tags:[armor_horse,material_static],Rotation:[180f,0f]}
execute if score materials funcs matches 2 run data merge entity @e[tag=armor_horse,limit=1] {ArmorItem:{id:iron_horse_armor,Count:1}}
...
execute if score materials funcs matches 2 run execute if score horse_saddle funcs matches 1 run data merge entity @e[tag=armor_horse,limit=1] {SaddleItem:{id:saddle,Count:1}}
...
execute if score materials funcs matches 3 run execute unless entity @e[tag=armor_horse,distance=..10] run summon minecraft:horse ~4.5 ~1.5 ~0.5 {Variant:1,Tame:True,NoAI:True,Silent:True,Tags:[armor_horse,material_static],Rotation:[180f,0f]}
execute if score materials funcs matches 3 run data merge entity @e[tag=armor_horse,limit=1] {ArmorItem:{id:golden_horse_armor,Count:1}}
...
execute if score materials funcs matches 3 run execute if score horse_saddle funcs matches 1 run data merge entity @e[tag=armor_horse,limit=1] {SaddleItem:{id:saddle,Count:1}}
...
execute if score materials funcs matches 4 run execute unless entity @e[tag=armor_horse,distance=..10] run summon minecraft:horse ~4.5 ~1.5 ~0.5 {Variant:1,Tame:True,NoAI:True,Silent:True,Tags:[armor_horse,material_static],Rotation:[180f,0f]}
execute if score materials funcs matches 4 run data merge entity @e[tag=armor_horse,limit=1] {ArmorItem:{id:diamond_horse_armor,Count:1}}
...
execute if score materials funcs matches 4 run execute if score horse_saddle funcs matches 1 run data merge entity @e[tag=armor_horse,limit=1] {SaddleItem:{id:saddle,Count:1}}
