...
execute if score wood funcs matches 0 run summon minecraft:boat ~-0.5 ~1.025 ~2 {Type:acacia,CustomName:"\"Acacia\"",CustomNameVisible:True,Tags:[wood_boat],Rotation:[90f,0f]}
...
execute if score wood funcs matches 1 run summon minecraft:boat ~-0.5 ~1.025 ~2 {Type:birch,CustomName:"\"Birch\"",CustomNameVisible:True,Tags:[wood_boat],Rotation:[90f,0f]}
...
execute if score wood funcs matches 2 run summon minecraft:boat ~-0.5 ~1.025 ~2 {Type:jungle,CustomName:"\"Jungle\"",CustomNameVisible:True,Tags:[wood_boat],Rotation:[90f,0f]}
...
execute if score wood funcs matches 3 run summon minecraft:boat ~-0.5 ~1.025 ~2 {Type:oak,CustomName:"\"Oak\"",CustomNameVisible:True,Tags:[wood_boat],Rotation:[90f,0f]}
...
execute if score wood funcs matches 4 run summon minecraft:boat ~-0.5 ~1.025 ~2 {Type:dark_oak,CustomName:"\"Dark Oak\"",CustomNameVisible:True,Tags:[wood_boat],Rotation:[90f,0f]}
...
execute if score wood funcs matches 5 run summon minecraft:boat ~-0.5 ~1.025 ~2 {Type:spruce,CustomName:"\"Spruce\"",CustomNameVisible:True,Tags:[wood_boat],Rotation:[90f,0f]}
